...
openai.api_key = "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" #API Key from Shyra's Account user_prompt = "clipart style of a "+p #input prompt or description of desired output
...
def user_input():
    ...
    return render_template('form.html', image_url = image_url)
